...
path = input('Please provide path for the csv file to be saved or press Enter to save in current directory (name of the csv file is Go_Players_Data_BS.csv)')
if path =='':
    file_path=""
